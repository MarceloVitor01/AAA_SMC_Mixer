...
class AAA_SMC_Mixer(ControlSurface):   # Make sure you update the name
    # Make sure you update the name
    __doc__ = " Script for AAA_SMC_Mixer in APC emulation mode "
    ...
    def _combine_active_instances():
        track_offset = 0
        scene_offset = 0
        for instance in AAA_SMC_Mixer._active_instances:   # Make sure you update the name
    ...
    def _do_combine(self):
        if self not in AAA_SMC_Mixer._active_instances:    # Make sure you update the name
            AAA_SMC_Mixer._active_instances.append(
                self)   # Make sure you update the name
            AAA_SMC_Mixer._combine_active_instances()  # Make sure you update the name

    def _do_uncombine(self):
        # Make sure you update the name
        if (self in AAA_SMC_Mixer._active_instances) and AAA_SMC_Mixer._active_instances.remove(self):
